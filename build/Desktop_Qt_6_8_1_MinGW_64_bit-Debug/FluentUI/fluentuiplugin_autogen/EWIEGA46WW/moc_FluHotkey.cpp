...
static constexpr auto qt_meta_stringdata_ZN9FluHotkeyE = QtMocHelpers::stringData(
    "FluHotkey",
    "QML.Element",
    "sequenceChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9FluHotkeyE[] = {
...
Q_CONSTINIT const QMetaObject FluHotkey::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9FluHotkeyE.offsetsAndSizes,
    qt_meta_data_ZN9FluHotkeyE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'sequence'
...
void FluHotkey::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FluHotkey::*)();
            if (_q_method_type _q_method = &FluHotkey::sequenceChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FluHotkey::*)();
            if (_q_method_type _q_method = &FluHotkey::nameChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (FluHotkey::*)();
            if (_q_method_type _q_method = &FluHotkey::isRegisteredChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (FluHotkey::*)();
            if (_q_method_type _q_method = &FluHotkey::activated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *FluHotkey::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9FluHotkeyE.stringdata0))
