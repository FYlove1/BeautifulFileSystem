...
static constexpr auto qt_meta_stringdata_ZN12FluTextStyleE = QtMocHelpers::stringData(
    "FluTextStyle",
    "QML.Element",
    "QML.Singleton",
    "true",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12FluTextStyleE[] = {
...
Q_CONSTINIT const QMetaObject FluTextStyle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12FluTextStyleE.offsetsAndSizes,
    qt_meta_data_ZN12FluTextStyleE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'family'
...
void FluTextStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::familyChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::CaptionChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::BodyChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::BodyStrongChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::SubtitleChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::TitleChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::TitleLargeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _q_method_type = void (FluTextStyle::*)();
            if (_q_method_type _q_method = &FluTextStyle::DisplayChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
...
void *FluTextStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12FluTextStyleE.stringdata0))
