...
static constexpr auto qt_meta_stringdata_ZN12FluFramelessE = QtMocHelpers::stringData(
    "FluFrameless",
    "QML.Element",
    "appbarChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12FluFramelessE[] = {
...
Q_CONSTINIT const QMetaObject FluFrameless::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12FluFramelessE.offsetsAndSizes,
    qt_meta_data_ZN12FluFramelessE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'appbar'
...
void FluFrameless::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FluFrameless::*)();
            if (_q_method_type _q_method = &FluFrameless::appbarChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FluFrameless::*)();
            if (_q_method_type _q_method = &FluFrameless::maximizeButtonChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (FluFrameless::*)();
            if (_q_method_type _q_method = &FluFrameless::minimizedButtonChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (FluFrameless::*)();
            if (_q_method_type _q_method = &FluFrameless::closeButtonChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (FluFrameless::*)();
            if (_q_method_type _q_method = &FluFrameless::topmostChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (FluFrameless::*)();
            if (_q_method_type _q_method = &FluFrameless::disabledChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (FluFrameless::*)();
            if (_q_method_type _q_method = &FluFrameless::fixSizeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
void *FluFrameless::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12FluFramelessE.stringdata0))
