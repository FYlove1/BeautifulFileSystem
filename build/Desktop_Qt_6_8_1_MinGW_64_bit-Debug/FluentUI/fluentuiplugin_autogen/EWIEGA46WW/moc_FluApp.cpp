...
static constexpr auto qt_meta_stringdata_ZN6FluAppE = QtMocHelpers::stringData(
    "FluApp",
    "QML.Element",
    "QML.Singleton",
    "true",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6FluAppE[] = {
...
Q_CONSTINIT const QMetaObject FluApp::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6FluAppE.offsetsAndSizes,
    qt_meta_data_ZN6FluAppE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
...
void FluApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FluApp::*)();
            if (_q_method_type _q_method = &FluApp::useSystemAppBarChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FluApp::*)();
            if (_q_method_type _q_method = &FluApp::windowIconChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (FluApp::*)();
            if (_q_method_type _q_method = &FluApp::localeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (FluApp::*)();
            if (_q_method_type _q_method = &FluApp::launcherChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *FluApp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6FluAppE.stringdata0))
