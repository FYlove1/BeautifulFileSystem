...
static constexpr auto qt_meta_stringdata_ZN14FluAccentColorE = QtMocHelpers::stringData(
    "FluAccentColor",
    "QML.Element",
    "darkestChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14FluAccentColorE[] = {
...
Q_CONSTINIT const QMetaObject FluAccentColor::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14FluAccentColorE.offsetsAndSizes,
    qt_meta_data_ZN14FluAccentColorE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'darkest'
...
void FluAccentColor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FluAccentColor::*)();
            if (_q_method_type _q_method = &FluAccentColor::darkestChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FluAccentColor::*)();
            if (_q_method_type _q_method = &FluAccentColor::darkerChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (FluAccentColor::*)();
            if (_q_method_type _q_method = &FluAccentColor::darkChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (FluAccentColor::*)();
            if (_q_method_type _q_method = &FluAccentColor::normalChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (FluAccentColor::*)();
            if (_q_method_type _q_method = &FluAccentColor::lightChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (FluAccentColor::*)();
            if (_q_method_type _q_method = &FluAccentColor::lighterChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (FluAccentColor::*)();
            if (_q_method_type _q_method = &FluAccentColor::lightestChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
void *FluAccentColor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14FluAccentColorE.stringdata0))
