...
static constexpr auto qt_meta_stringdata_ZN12FluRectangleE = QtMocHelpers::stringData(
    "FluRectangle",
    "QML.Element",
    "colorChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12FluRectangleE[] = {
...
Q_CONSTINIT const QMetaObject FluRectangle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12FluRectangleE.offsetsAndSizes,
    qt_meta_data_ZN12FluRectangleE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'color'
...
void FluRectangle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FluRectangle::*)();
            if (_q_method_type _q_method = &FluRectangle::colorChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FluRectangle::*)();
            if (_q_method_type _q_method = &FluRectangle::radiusChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *FluRectangle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12FluRectangleE.stringdata0))
