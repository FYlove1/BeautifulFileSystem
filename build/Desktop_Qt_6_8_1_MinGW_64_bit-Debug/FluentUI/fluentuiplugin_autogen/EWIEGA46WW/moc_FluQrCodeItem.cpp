...
static constexpr auto qt_meta_stringdata_ZN13FluQrCodeItemE = QtMocHelpers::stringData(
    "FluQrCodeItem",
    "QML.Element",
    "textChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13FluQrCodeItemE[] = {
...
Q_CONSTINIT const QMetaObject FluQrCodeItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13FluQrCodeItemE.offsetsAndSizes,
    qt_meta_data_ZN13FluQrCodeItemE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'text'
...
void FluQrCodeItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FluQrCodeItem::*)();
            if (_q_method_type _q_method = &FluQrCodeItem::textChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (FluQrCodeItem::*)();
            if (_q_method_type _q_method = &FluQrCodeItem::colorChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (FluQrCodeItem::*)();
            if (_q_method_type _q_method = &FluQrCodeItem::bgColorChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (FluQrCodeItem::*)();
            if (_q_method_type _q_method = &FluQrCodeItem::sizeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *FluQrCodeItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13FluQrCodeItemE.stringdata0))
