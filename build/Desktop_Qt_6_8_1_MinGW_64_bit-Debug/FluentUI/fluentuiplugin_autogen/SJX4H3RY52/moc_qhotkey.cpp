...
#include "../../../../../FluentUI/qhotkey/qhotkey.h"
...
static constexpr auto qt_meta_stringdata_ZN7QHotkeyE = QtMocHelpers::stringData(
    "QHotkey",
    "activated",
    "",
    "released",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7QHotkeyE[] = {
...
Q_CONSTINIT const QMetaObject QHotkey::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7QHotkeyE.offsetsAndSizes,
    qt_meta_data_ZN7QHotkeyE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7QHotkeyE_t,
        // property 'registered'
...
void QHotkey::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QHotkey::*)(QPrivateSignal);
            if (_q_method_type _q_method = &QHotkey::activated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QHotkey::*)(QPrivateSignal);
            if (_q_method_type _q_method = &QHotkey::released; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QHotkey::*)(bool );
            if (_q_method_type _q_method = &QHotkey::registeredChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QHotkey::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7QHotkeyE.stringdata0))
