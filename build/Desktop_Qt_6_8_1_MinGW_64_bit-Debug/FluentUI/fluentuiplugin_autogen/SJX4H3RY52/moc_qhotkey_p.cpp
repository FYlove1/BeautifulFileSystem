...
#include "../../../../../FluentUI/qhotkey/qhotkey_p.h"
...
static constexpr auto qt_meta_stringdata_ZN14QHotkeyPrivateE = QtMocHelpers::stringData(
    "QHotkeyPrivate",
    "addMappingInvoked",
    "",
    "Qt::Key",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14QHotkeyPrivateE[] = {
...
Q_CONSTINIT const QMetaObject QHotkeyPrivate::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14QHotkeyPrivateE.offsetsAndSizes,
    qt_meta_data_ZN14QHotkeyPrivateE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14QHotkeyPrivateE_t,
        // Q_OBJECT / Q_GADGET
...
void *QHotkeyPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14QHotkeyPrivateE.stringdata0))
