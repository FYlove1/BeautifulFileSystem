...
0x68,0x18,0x0,0x0,0x63,0x36,0x64,0x37,
...
aotContext->setInstructionPointer(8);
#endif
aotContext->initGetEnumLookup(25, []() { static const auto t = QMetaType::fromName("FluentIcons"); return t; }().metaObject(), "Type", "FavoriteStarFill");
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<int *>(argv[0]) = int();
...
aotContext->setInstructionPointer(14);
#endif
aotContext->initGetEnumLookup(27, []() { static const auto t = QMetaType::fromName("FluentIcons"); return t; }().metaObject(), "Type", "FavoriteStar");
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<int *>(argv[0]) = int();
