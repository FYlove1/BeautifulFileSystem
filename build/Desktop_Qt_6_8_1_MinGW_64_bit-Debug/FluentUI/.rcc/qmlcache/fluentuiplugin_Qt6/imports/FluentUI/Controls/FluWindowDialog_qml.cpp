...
0xdc,0xe,0x0,0x0,0x63,0x36,0x64,0x37,
...
if (argv[0]) {
    if (!r2_6.isValid())
        aotContext->setReturnValueUndefined();
    *static_cast<QQmlComponent * *>(argv[0]) = aotContext->engine->fromVariant<QQmlComponent *>(r2_6);
}
return;
label_0:;
// generate_LoadQmlContextPropertyLookup
...
// generate_Ret
if (argv[0]) {
    *static_cast<QQmlComponent * *>(argv[0]) = static_cast<QQmlComponent *>(r2_8);
}
return;
}
