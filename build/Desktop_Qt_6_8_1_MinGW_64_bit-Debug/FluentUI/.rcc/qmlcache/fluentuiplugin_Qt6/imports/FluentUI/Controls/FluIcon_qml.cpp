...
0x78,0xc,0x0,0x0,0x63,0x36,0x64,0x37,
...
r2_2 = [&](){ auto arg = QStringLiteral("#FFFFFF"); return aotContext->constructValueType([]() { static const auto t = QMetaType::fromName("QColor"); return t; }(), []() { static const auto t = QMetaType::fromName("QQuickColorValueType"); return t; }().metaObject(), 1, &arg); }();
{
}
// generate_Jump
{
