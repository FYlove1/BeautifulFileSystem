...
0x28,0x14,0x0,0x0,0x63,0x36,0x64,0x37,
...
// generate_Ret
if (argv[0]) {
    *static_cast<QQmlComponent * *>(argv[0]) = static_cast<QQmlComponent *>(r2_4);
}
return;
label_0:;
// generate_LoadQmlContextPropertyLookup
...
// generate_Ret
if (argv[0]) {
    *static_cast<QQmlComponent * *>(argv[0]) = static_cast<QQmlComponent *>(r2_7);
}
return;
label_1:;
{
...
if (argv[0]) {
aotContext->setReturnValueUndefined();
    *static_cast<QQmlComponent * *>(argv[0]) = static_cast<QQmlComponent *>(nullptr);
}
return;
}
